package com.dhkpo.effectivejava.chapter01.item03.serialization;
...
public class SerializationExample {
    ...
    public static void main(String[] args) {
        Book book = new Book("12345", "이펙티브 자바", "HK", LocalDate.of(2023, 7, 11));
        ...
        Book.name = "whiteship";
        Book desirializedBook = example.deserialize();

        System.out.println(book);
        System.out.println(desirializedBook);
    }
}
